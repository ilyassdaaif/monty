...
/**
 * main-ilyass - entry point
 * @argcounter: arguments count
 * @argvalue: list of arguments
 * Return: always 0
 */

int main-ilyass(int argcounter, char *argvalue[])
{
	if (argcounter != 2)
	{
...
/**
 * create_node-ilyass - Creates a node.
 ...
 */
void add_to_queue-ilyass(stack_t **new_node, __attribute__((unused))unsigned int line_number)
{
	stack_t *temporary;
